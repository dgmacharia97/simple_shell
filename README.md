...
Syscall
 By: Julien Barbier
 Weight: 10
 Project to be done in teams of 2 people (your team: BRIAN ACHIENG, Daniel gichohi macharia Gichohi)
...
$
Checks
The Checker will be released at the end of the project (1-2 days before the
deadline). We strongly encourage the entire class to work together to create a
suite of checks covering both regular tests and edge cases for each task. See
task 8. Test suite.
